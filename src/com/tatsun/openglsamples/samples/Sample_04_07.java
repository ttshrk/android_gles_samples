...
import com.tatsun.lib.utils.MathUtils;
import com.tatsun.openglsamples.R;

/**
 * Sample_04_06. 2D + 3D
 */
public class Sample_04_07 extends Activity {
	...
	private class RendererSample implements GLSurfaceView.Renderer {
		...
		public void onDrawFrame(GL10 gl) {
			...
			gl.glLoadIdentity();
			gl.glFrustumf(-1, 1, -1.5f, 1.5f, 1f, 100);
		...
		public void onSurfaceChanged(GL10 gl, int width, int height) {
			...
			for (int i = 0; i < UNIT_COUNT; ++i) {
				positions[i] = new float[] {
						MathUtils.getRangeRand(-1.8f, 1.8f), vs, MathUtils.getRangeRand(-0.9f, 0.9f)
				};
			}
