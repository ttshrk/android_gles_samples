...
import com.tatsun.lib.utils.Logger;
...
public class SecondActivity extends Activity implements
	...
	private static final ListItem[][] activities = new ListItem[][] {
			...
			// lighting, normal, stencil
			{
					// anbient
					// defuse
					new ListItem("defuse (camera view)",
							com.tatsun.openglsamples.samples.Sample_05_01.class),
			// lighting
			// bump map
			// normal map
			// grow shading
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
			long id) {
		ListView listView = (ListView) parent;
		Logger.i("onItemSelected", (String) listView.getItemAtPosition(position));
	}
